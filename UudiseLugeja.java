...
public class UudiseLugeja extends Application {
    ...
    private boolean esimeneStart = true;
    ...
    public void start(Stage stage) throws IOException {
        ...
        // Esimesel stardil vaatame viimati vaadatud uudist
        if (esimeneStart) {
            esimeneStart = false;

            List<String> uudiseList = ViimaneVaadatudUudis.getViimaneVaadatudUudis();

            if (!uudiseList.isEmpty()) {
                pealkiri.setText(uudiseList.get(0));
                sisu.setText(uudiseList.get(1));
                link1.setText(uudiseList.get(2));
            }
        }
